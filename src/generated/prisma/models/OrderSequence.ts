...
export type OrderSequenceWhereInput = {
  ...
  year?: Prisma.IntFilter<"OrderSequence"> | number
  value?: Prisma.IntFilter<"OrderSequence"> | number
}
...
export type OrderSequenceScalarWhereWithAggregatesInput = {
  ...
  year?: Prisma.IntWithAggregatesFilter<"OrderSequence"> | number
  value?: Prisma.IntWithAggregatesFilter<"OrderSequence"> | number
}
...
export type OrderSequenceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"year" | "value", ExtArgs["result"]["orderSequence"]>
...
export interface OrderSequenceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const orderSequenceWithYearOnly = await prisma.orderSequence.findMany({ select: { year: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrderSequences and only return the `year`
   * const orderSequenceWithYearOnly = await prisma.orderSequence.createManyAndReturn({
   *   select: { year: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrderSequences and only return the `year`
   * const orderSequenceWithYearOnly = await prisma.orderSequence.updateManyAndReturn({
   *   select: { year: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrderSequenceFieldRefs {
  readonly year: Prisma.FieldRef<"OrderSequence", 'Int'>
  readonly value: Prisma.FieldRef<"OrderSequence", 'Int'>
}
